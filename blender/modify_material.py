...
def set_modify_material(
        obj, 
        material, 
        obj_texture_img_list, 
        mat_randomize_mode, 
        is_transfer=True):
    ...
    print(f'obj_texture_img_list: {obj_texture_img_list}')
    print(f'mat_randomize_mode: {mat_randomize_mode}')
    print(f'obj.material_slots: {obj.material_slots}')
    
    for mat_slot in obj.material_slots:
        if mat_slot.material:
            print('mat_slot.material is True')
            if mat_slot.material.node_tree:
                print('mat_slot.material.node_tree is True')
                srcmat = material
                mat = srcmat.copy()
            ...
            print('mat_slot.material is False')
